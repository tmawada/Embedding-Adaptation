...
| Query-DANN v2 + distillation score (linear adapter) | 0.9412 | 0.7329 | 0.6206 | 0.9173 | 0.6839 | 0.5766 |
...
| TSDAE-SAPT (task queries) + Query-DANN v2 + distillation score (linear adapter) | 0.9409 | 0.7278 | 0.6181 | 0.9191 | 0.6901 | 0.5774 |
...
| Query-DANN v2 + distillation score (linear adapter) | 0.6206 | 0.5766 | -4.41 | -7.1% | +3.52 | 0.001* |
...
| TSDAE-SAPT (task queries) + Query-DANN v2 + distillation score (linear adapter) | 0.6181 | 0.5774 | -4.08 | -6.6% | +3.85 | 0.001* |
